...
/**
 * Represents a task assigned to this finance officer by a Project Manager.
 * Synced from the project-service via TASK_ASSIGNED notifications.
 */
@Entity
@Table(name = "assigned_tasks",
        uniqueConstraints = @UniqueConstraint(name = "uq_pm_task_id_finance", columnNames = "pm_task_id"))
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class AssignedTask {
    ...
    /** Populated when PM rejects this task — reason shown back to the officer. */
